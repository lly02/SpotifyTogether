(async () => {
    ...
    function f() {
        "object" != typeof chrome.windows || c || "undefined" == typeof console || "function" != typeof console.log || console.log.apply(console, arguments);
    }
    function m(e, t) {
    ...
    function U(e) {
        ...
        e.RTCPeerConnection.prototype.getStats = function () {
            ...
            let i = function (e) {
                    ...
                    return (
                        n.forEach((e) => {
                            let n = { id: e.id, timestamp: e.timestamp, type: { localcandidate: "local-candidate", remotecandidate: "remote-candidate" }[e.type] || e.type };
                            e.names().forEach((t) => {
                                n[t] = e.stat(t);
                            }),
                                (t[n.id] = n);
    ...
    function X(e, t) {
        ...
        let n = { inboundrtp: "inbound-rtp", outboundrtp: "outbound-rtp", candidatepair: "candidate-pair", localcandidate: "local-candidate", remotecandidate: "remote-candidate" },
        ...
        (e.RTCIceCandidate && "relayProtocol" in e.RTCIceCandidate.prototype) || // Hook up the augmented candidate in onicecandidate and
            ...
            d(e, "icecandidate", (e) => {
                if (e.candidate) {
                    ...
                    "relay" === n.type && (e.candidate.relayProtocol = { 0: "tls", 1: "tcp", 2: "udp" }[n.priority >> 24]); // to relayProtocol.
                }
                return e;
            });
    }
    function ev(e, n) {
        ...
        let r = function (e) {
            ...
            o = function (e) {
                ...
                let t = 65536;
                return (
                    "firefox" === n.browser && (t = n.version < 57 ? (-1 === e ? 16384 : 2147483637) : n.version < 60 ? (57 === n.version ? 65535 : 65536) : 2147483637), // fragmentation.
                    t
                );
            },
            s = function (e, r) {
    ...
    function eS(e, t) {
        /* remove a=extmap-allow-mixed for webrtc.org < M71 */ if (!e.RTCPeerConnection || ("chrome" === t.browser && t.version >= 71) || ("safari" === t.browser && t.version >= 605)) return;
    ...
    (ey.generateIdentifier = function () {
        ...
        (ey.parseRtpEncodingParameters = function (e) {
            ...
            c.length > 0 && c[0].length > 1 && c[0][0] === a && (t = c[0][1]),
                r.codecs.forEach((e) => {
                    if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
                        ...
                        a && t && (r.rtx = { ssrc: t }), n.push(r), i && (((r = JSON.parse(JSON.stringify(r))).fec = { ssrc: a, mechanism: o ? "red+ulpfec" : "red" }), n.push(r));
                    }
                }),
            ...
            return (
                l.length &&
                    ((l = 0 === l[0].indexOf("b=TIAS:") ? parseInt(l[0].substring(7), 10) : 0 === l[0].indexOf("b=AS:") ? 950 * parseInt(l[0].substring(5), 10) - 16e3 : void 0),
                    n.forEach((e) => {
                        e.maxBitrate = l;
                    })),
                n
            ...
            let n = (function (e) {
                    ...
                    return (
                        n.mozGetUserMedia
                            ...
                            ? ((t.browser = "safari"), (t.version = p(n.userAgent, /AppleWebKit\/(\d+)\./, 1)), (t.supportsUnifiedPlan = e.RTCRtpTransceiver && "currentDirection" in e.RTCRtpTransceiver.prototype))
                            : (t.browser = "Not a supported browser."),
                        t
                    );
                })(e),
                r = { browserDetails: n, commonShim: em, extractVersion: p, disableLog: h, disableWarnings: u, sdp: eg }; // Shim browser if found.
            switch (n.browser) {
                case "chrome":
    ...
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`;
        ...
        eI = { iceServers: [{ urls: "stun:stun.l.google.com:19302" }, { urls: ["turn:eu-0.turn.peerjs.com:3478", "turn:us-0.turn.peerjs.com:3478"], username: "peerjs", credential: "peerjsp" }], sdpSemantics: "unified-plan" },
    ...
    class eV {
        ...
        /** Set up various WebRTC listeners. */ _setupListeners(e) {
            ...
            eO.log("Listening for ICE candidates."),
                (e.onicecandidate = (e) => {
                    e.candidate && e.candidate.candidate && (eO.log(`Received ICE candidates for ${t}:`, e.candidate), i.socket.send({ type: O.Candidate, payload: { candidate: e.candidate, type: r, connectionId: n }, dst: t }));
                }),
            ...
            try {
                ...
                try {
                    await e.setLocalDescription(n),
                        ...
                        t.socket.send({ type: O.Answer, payload: { sdp: n, type: this.connection.type, connectionId: this.connection.connectionId }, dst: this.connection.peer });
                } catch (e) {
    ...
    class eY extends eH {
        ...
        /** Called by the Negotiator when the DataChannel is ready. */ _initializeDataChannel(e) {
            (this.dataChannel = e),
     ...
     */ answer(
            ...
            (this._localStream = e), t && t.sdpTransform && (this.options.sdpTransform = t.sdpTransform), this._negotiator.startConnection({ ...this.options._payload, _stream: e }); // Retrieve lost messages stored because PeerConnection not set up.
    ...
    class eK {
        ...
        /** Get a unique ID from the server via XHR and initialize with it. */ async retrieveId() {
            try {
                ...
                let e = "";
                throw (
                    ("/" === this._options.path && this._options.host !== eM.CLOUD_HOST && (e = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),
    ...
    class eX extends eH {
         ...
         */ /** Allows user to close connection. */ close(e) {
            ...
            this._negotiator && (this._negotiator.cleanup(), (this._negotiator = null)),
                this.provider && (this.provider._removeConnection(this), (this.provider = null)),
                this.dataChannel && ((this.dataChannel.onopen = null), (this.dataChannel.onmessage = null), (this.dataChannel.onclose = null), (this.dataChannel = null)),
                this.open && ((this._open = !1), super.emit("close"));
        }
    ...
    class e1 extends eG {
            ...
            switch (t) {
                ...
                case O.Offer: {
                    ...
                    if ((t && (t.close(), eO.warn(`Offer received for existing Connection ID:${e}`)), n.type === P.Media)) {
                        ...
                        let i = new this._serializers[n.serialization](r, this, { connectionId: e, _payload: n, metadata: n.metadata, label: n.label, serialization: n.serialization, reliable: n.reliable });
        ...
        /** Stores messages without a set up connection, to be claimed later. */ _storeMessage(e, t) {
        ...
        constructor(e, t) {
            ...
            if (
                ...
                (t = { debug: 0, host: eM.CLOUD_HOST, port: eM.CLOUD_PORT, path: "/", key: e1.DEFAULT_KEY, token: eM.randomToken(), config: eM.defaultConfig, referrerPolicy: "strict-origin-when-cross-origin", serializers: {}, ...t }),
                (this._options = t),
                (this._serializers = { ...this._serializers, ...this.options.serializers }),
                "/" === this._options.host && (this._options.host = chrome.windows.location.hostname),
                this._options.path && ("/" !== this._options.path[0] && (this._options.path = "/" + this._options.path), "/" !== this._options.path[this._options.path.length - 1] && (this._options.path += "/")),
